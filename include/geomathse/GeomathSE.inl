...
#define GSE_API extern "C" __declspec( dllimport )
#define GSE_CPPAPI __declspec( dllimport )
#else
#define GSE_API extern "C" __attribute__ ((visibility("default")))
#define GSE_CPPAPI __attribute__ ((visibility("default")))
#endif 

GSE_CPPAPI geostar::geo_factory& _gf();
GSE_CPPAPI geostar::geo_algorithm& _ga();
GSE_API geostar::geo_factory* _gf2();
GSE_API geostar::geo_algorithm* _ga2();
...
struct safe_ga
{
	...
	double xy2t(geo_object* p,const double* xy)
	{
		return m_a->xy2t(p,xy);
	}
