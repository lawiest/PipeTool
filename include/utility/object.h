...
/// \brief 定义读写属性
#define GS_DEFINE_RWPROPERTY(T,N,D)   T& N(){return D;}
/// \brief 定义只写属性
#define GS_DEFINE_RPROPERTY(T,N,D)   const T& N()const{return D;}
...
#define DECLARE_CLASS_NAME(class_name)  virtual UTILITY_NAME::GsString  AllClassName(){return UTILITY_NAME::GsString(#class_name);}
//#define DECLARE_CLASS_NAME_IMP(class_name)  UTILITY_NAME::GsString  class_name::ClassName(){return GsString(#class_name);}
UTILITY_ENDNS
