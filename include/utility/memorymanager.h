...
public:
	...
	/// \brief 拷贝构造
	/// \param rhs 
	GsGrowByteBuffer(const GsGrowByteBuffer&  rhs);
	...
	/// \brief 赋值
	GsGrowByteBuffer& operator=(const GsGrowByteBuffer& rsh);
...
protected:
	...
	/// \param k 
	/// \param v 
	virtual void OnEraseItem(const K& k, V& v)
	{
...
public:
	...
	void Add(const K& k, const V& v)
	{
		...
		{
			OnEraseItem(m_Data.back().first, m_Data.back().second);
