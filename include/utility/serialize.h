...
protected:
	...
	//临时文件存储路径
	GsString m_strTmpPath;

public:
	/// \brief 临时文件存储路径
	GsString TempPath();
	void TempPath(const char* strTmpPath);
	/// \brief 用户实现自定义对象的类厂
	/// \return 
